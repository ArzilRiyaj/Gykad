...
$trainer=$t->get_trainer_by_id($_SESSION["user"]["user_id"])
?>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="../Trainers/trainer_images/<?=$trainer->trainer_id ?>-0.jpg" class="img-radius"
                                            alt="User-Profile-Image">
                                        <span><?=$trainer->trainer_fname ?></span>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="../Trainers/trainer_dashboard.php">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="active">
                                            <a href="../Trainers/view_all_trainees.php ">
                                                <span class="pcoded-mtext">View All Trainees</span>
                                            </a>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="../packages/manage_packages.php ">
                                                <span class="pcoded-mtext">View packages</span>
                                            </a>
                                        </li>
